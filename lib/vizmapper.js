...
function drawChangingSourceConnections()
{
    ...
    for (var i=0;i<keys.length;i++) 
    {
        if (connectionGlyphMap.get(keys[i]).sink != undefined) 
        {
            ...
            //globalP.line(_graphCenterX,_graphCenterY-width/2,x2,y2-width/2);
            //globalP.line(_graphCenterX,_graphCenterY+width/2,x2,y2+width/2);
            globalP.quad(_graphCenterX,_graphCenterY-width/2,x2,y2-width/2,x2,y2+width/2,_graphCenterX,_graphCenterY+width/2);
        }
    }
...
function drawChangingSinkConnections()
{
    ...
    for (var i=0;i<keys.length;i++) 
    {
        if (connectionGlyphMap.get(keys[i]).sink != undefined) 
        {
            ...
            globalP.line(x1,y1-width/2,_graphCenterX,_graphCenterY-width/2);
            globalP.line(x1,y1+width/2,_graphCenterX,_graphCenterY+width/2);
        }
    }
...
/*
            ...
            */
            ...
            //globalP.line(x1,y1-width/2,x2,y2-width/2);
            //globalP.line(x1,y1+width/2,x2,y2+width/2);
