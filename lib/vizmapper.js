...
// button layouts
var buttonGlyphMap = [{mouseOver:false},{mouseOver:false}];
    ...
    window.AppView = Backbone.View.extend(
    {
        ...
        saveNewSourceToServer: function() 
        {
            ...
            for (var i=nodes.length-1;i>=0;i--)
            {
                ...
                // already exists
                if (str+'/'+$('#source-name-input').val() === name) 
                {
                    this.saveToServer(); 
                    return;
                }
        ...
        saveNewSinkToServer: function() 
        {
            ...
            for (var i=nodes.length-1;i>=0;i--)
            {
                ...
                // already exists
                if (str+'/'+$('#sink-name-input').val() === name) 
                {
                    this.saveToServer(); 
                    return;
                }
...
function globalP(p) 
{
	...
	p.mouseClicked = function() 
    {
        ...
        /*
        else if ($('#edit-tab').hasClass('active')) 
        {
	...
	p.draw = function() 
    {
        ...
        if ($('#view-tab').hasClass('active')) 
        {
            ...
            $('html').toggleClass('addColor',false);
        ...
        else 
        {
            ...
            $('html').toggleClass('viewColor',false);
            $('html').toggleClass('editColor',false);
            $('html').toggleClass('addColor',true);

            p.background(255,255,224);
            drawBackground();
            updateNodeMouseState();
            updateEdgeMouseState();
            drawNodes();
...
function updateNodeMouseState() 
{
    ...
    {
        $('#selectedSink').text(selectedSink);
    } 
    else 
    {
        $('#selectedSink').text(mousedDestination);
    }
}
...
function updateButtonMouseState() 
{
    var topY = 118;
    var leftX = 260;
...
function drawButtons() 
{
    ...
    globalP.fill(0);
    globalP.textSize(14);
    globalP.text('create source',leftX-156,topY-20);
    globalP.text('create sink',rightX+50,topY-20);
...
function activateViewMode() {
    ...
    $('#add-node-form').toggle(false);

	$('#view-tab').toggleClass('active',true);
	$('#view-tab').toggleClass('inactive',false);
	$('#edit-tab').toggleClass('active',false);
	$('#edit-tab').toggleClass('inactive',true);
	$('#add-tab').toggleClass('active',false);
	$('#add-tab').toggleClass('inactive',true);
...
function activateEditMode() {
	...
	$('#view-tab').toggleClass('active',false);
	$('#view-tab').toggleClass('inactive',true);
	$('#edit-tab').toggleClass('active',true);
	$('#edit-tab').toggleClass('inactive',false);
	$('#add-tab').toggleClass('active',false);
	$('#add-tab').toggleClass('inactive',true);
