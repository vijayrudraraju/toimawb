...
$(function() 
{
    ...
    {
        window.App.saveSourceToServer();
    });
    $('#create-sink-button').click(function() 
    {
        window.App.saveSinkToServer();
    });
    ...
    window.AppView = Backbone.View.extend(
    {
        ...
        onReset: function(coll,resp) 
        {
            ...
            {
                console.log('local and remote mawbs found, using remote as real');
                Blawks.at(0).sync = Backbone.localSync;
                try 
                {
                    Blawks.at(0).save();
...
function updateNodeMouseState() {
    ...
    if ($('#view-tab').hasClass('active') || $('#edit-tab').hasClass('active')) {
...
function drawListGlyphs() {
    ...
    globalP.fill(0);
    globalP.textSize(14);
    globalP.text('this branch of sources',10,topY);
    globalP.text('this branch of sinks',screenWidth-190,topY);
    globalP.textSize(12);
    for (var i=0;i<outputSet.length;i++) {
...
function drawTraversalGlyphs() {
    ...
    globalP.textSize(16);
    globalP.noStroke();
    globalP.text('source path trace', centerX1-110, centerY1-130);
    globalP.text('sink path trace', centerX2-70, centerY2-130);
