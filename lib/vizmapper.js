...
function drawListGlyphs() {
    ...
    globalP.fill(0);
    globalP.textSize(14);
    globalP.text('this branch of outputs',10,138);
    globalP.text('this branch of inputs',screenWidth-190,138);
    globalP.textSize(12);
    for (var i=0;i<outputSet.length;i++) {
...
function drawTraversalGlyphs() {
    ...
    globalP.textSize(16);
    globalP.noStroke();
    globalP.text('output path trace', centerX1-110, centerY1-130);
    globalP.text('input path trace', centerX2-70, centerY2-130);
...
function activateViewMode() {
	...
	$('#addTab').toggleClass('active',false);
	$('#addTab').toggleClass('inactive',true);
...
function activateAddMode() {
	...
	$('#editTab').toggleClass('active',false);
	$('#editTab').toggleClass('inactive',true);
	$('#addTab').toggleClass('active',true);
	$('#addTab').toggleClass('inactive',false);
