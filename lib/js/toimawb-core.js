...
TOI.MAIN.start = function() {
    ...
    this.stackArr[0].innerHTML = this.pointer;
    ...
    function setFrame(index) {
        ...
        for (var i=0;i<frameConfig.length;i++) {
            ...
            if (frameConfig[i][0] === 'letter') {
                ...
                setText(that.pArr[i],that.data[that.pointer]['letterhood'][letterCount]);
                letterCount++;
            } else if (frameConfig[i][0] === 'word') {
                //console.log(i, that.data[that.pointer]['wordhood'][wordCount]);
                setText(that.pArr[i],that.data[that.pointer]['wordhood'][wordCount]);
                wordCount++;
            } else if (frameConfig[i][0] === 'paragraph') {
                //console.log(i, that.data[that.pointer]['paragraphhood'][paragraphCount].replace(/,/g,' '));
                setText(that.pArr[i],that.data[that.pointer]['paragraphhood'][paragraphCount].replace(/,/g,' '));
                paragraphCount++;
            }
