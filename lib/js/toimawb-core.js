...
TOIMAWB.DATA.INIT = {
    ...
    'paragraphs': ['toimawb is a reimagining of the notebook', 'toimawb is a tool for introspection', 'toimawb finds patterns in your thoughts']
};
...
TOIMAWB.start = function() {
    ...
    function setFrame(index) {
        ...
        var letters = TOIMAWB.DATA.letters;
        var words = TOIMAWB.DATA.words;
        var paragraphs = TOIMAWB.DATA.paragraphs;
